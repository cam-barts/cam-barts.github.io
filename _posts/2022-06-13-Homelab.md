...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/webhooksite/webhook.site" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - webhooksite/webhook.site: ⚓️ Easily test HTTP webhooks with this handy tool that displays requests instantly.</h4>
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://git.tt-rss.org/fox/ttrss-docker-compose.git/tree/README.md?h=static-dockerhub" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">README.md - ttrss-docker-compose.git -</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/recurser/string-is" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - recurser/string-is: An open-source, privacy-friendly online string toolkit for developers.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/gchq/CyberChef" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - gchq/CyberChef: The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/photoprism/photoprism" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - photoprism/photoprism: AI-Powered Photos App for the Decentralized Web 🌈💎✨</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/paperless-ngx/paperless-ngx" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - paperless-ngx/paperless-ngx: A community-supported supercharged version of paperless: scan, index and archive all your physical documents</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/moodle/moodle" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - moodle/moodle: Moodle - the world's open source learning platform</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://gitlab.com/gitlab-org/gitlab" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitLab.org / GitLab · GitLab</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/Lissy93/dashy" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - Lissy93/dashy: 🚀 A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more!</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/coder/code-server" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - coder/code-server: VS Code in the browser</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/WantGuns/bin" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - WantGuns/bin: highly opinionated, minimal pastebin</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/appsmithorg/appsmith" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - appsmithorg/appsmith: Low code project to build admin panels, internal tools, and dashboards. Integrates with 15+ databases and any API.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/vnl/vikunja_app" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - vnl/vikunja_app: Vikunja is an Open-Source, self-hosted To-Do list application for all platforms. This project is a fork of the original flutter project using Flutter. https://vikunja.io/</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/louislam/uptime-kuma" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - louislam/uptime-kuma: A fancy self-hosted monitoring tool</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/TandoorRecipes/recipes" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - TandoorRecipes/recipes: Application for managing recipes, planning meals, building shopping lists and much much more!</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/portainer/portainer" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - portainer/portainer: Making Docker and Kubernetes management easy.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/caronc/apprise-api" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - caronc/apprise-api: A lightweight REST framework that wraps the Apprise Notification Library</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/TryGhost/Ghost" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - TryGhost/Ghost: Turn your audience into a business. Publishing, memberships, subscriptions and newsletters.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/postgres/postgres" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - postgres/postgres: Mirror of the official PostgreSQL GIT repository. Note that this is just a *mirror* - we don't work with pull requests on github. To contribute, please see https://wiki.postgresql.org/wiki/Submitting_a_Patch</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/nocodb/nocodb" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - nocodb/nocodb: 🔥 🔥 🔥 Open Source Airtable Alternative - turns any MySQL, Postgres, SQLite into a Spreadsheet with REST APIs.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/healthchecks/healthchecks" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - healthchecks/healthchecks: A cron monitoring tool written in Python & Django</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/benbusby/whoogle-search" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - benbusby/whoogle-search: A self-hosted, ad-free, privacy-respecting metasearch engine</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/NginxProxyManager/nginx-proxy-manager" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - NginxProxyManager/nginx-proxy-manager: Docker container for managing Nginx proxy hosts with a simple, powerful interface</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/matomo-org/matomo" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - matomo-org/matomo: Liberating Web Analytics. Star us on Github? +1. Matomo is the leading open alternative to Google Analytics that gives you full control over your data. Matomo lets you easily collect data from websites & apps and visualise this data and extract insights. Privacy is built-in. We love Pull Requests!</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/gotify/server" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - gotify/server: A simple server for sending and receiving messages in real-time per WebSocket. (Includes a sleek web-ui)</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/tannercollin/Notica" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - tannercollin/Notica: Send browser notifications from your terminal. No installation. No registration.</h4>
		<p class="rich-link-card-description">
...
<div class="rich-link-card-container"><a class="rich-link-card" href="https://github.com/dani-garcia/vaultwarden" target="_blank">
	...
	<div class="rich-link-card-text">
		<h4 class="rich-link-card-title">GitHub - dani-garcia/vaultwarden: Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs</h4>
		<p class="rich-link-card-description">
